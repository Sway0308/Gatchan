...
namespace Elementary.Core
{
    ...
    public class DateFuncCore
    {
        ...
        public static TimeSpan ToTimeSpan(object value)
        {
            ...
            if (value is string)
            {
                int hours = BaseFuncCore.CInt(StrFuncCore.StrLeft(value.ToString(), 2));
                int minutes = BaseFuncCore.CInt(StrFuncCore.StrRight(value.ToString(), 2));
